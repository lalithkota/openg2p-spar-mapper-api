...
from openg2p_spar_mapper_api.controllers.sync_mapper_controller import SyncMapperController
from openg2p_spar_mapper_api.services import RequestValidationException

class TestSyncMapperController(unittest.TestCase):
    def setUp(self) -> None:
        self.mock_request = MagicMock(spec=Request)
        self.mock_request_validation = patch("openg2p_spar_mapper_api.controllers.sync_mapper_controller.RequestValidation").start()
        self.mock_response_helper = patch("openg2p_spar_mapper_api.controllers.sync_mapper_controller.SyncResponseHelper").start()
